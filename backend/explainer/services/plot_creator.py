...
from explainer.constants import PLOT_HEIGHT, PLOT_WIDTH, TOP5_CENTERED_IMPORTANCE_TITLE
from xgboost import XGBClassifier
from explainer.services.model_explainer import ModelExplainer
from explainer.constants import (
    COLORS,
    FONT_SIZE,
    FIG_SIZE,
    DPI,
...
class PlotCreator:
    ...
    def __save_fig(self, fig: Any, fig_name: str) -> str:
        ...
        return settings.MEDIA_URL + "plots/" + name
